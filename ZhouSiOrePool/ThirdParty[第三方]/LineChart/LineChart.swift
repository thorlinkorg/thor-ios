...
class LineChart: UIView {
    ...
    /// Contains the main line wclohich represents the data
    ...
    private func setupView() {
        ...
        gradientLayer.colors = [chartFillColor.cgColor, chartFillColor.cgColor]
    ...
    private func drawChart() {
        if let dataPoints = dataPoints,
            ...
            lineLayer.strokeColor = baseTabTextColor.cgColor
...
//                lineLayer.strokeColor = #colorLiteral(red: 0.2784313725, green: 0.5411764706, blue: 0.7333333333, alpha: 1).cgColor
                lineLayer.strokeColor = UIColor.init(hexStr: "0xcccccc").cgColor
